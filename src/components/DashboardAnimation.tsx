  ...
  return (
    <div className="relative w-full max-w-[450px] aspect-square select-none flex items-center justify-center overflow-visible">
      ...
      <motion.div 
        ...
        className="absolute -left-3 sm:-left-7 top-[40px] bg-[#1E293B]/95 backdrop-blur-xs text-white p-3 rounded-2xl border border-slate-700/50 shadow-xl z-30 w-32 flex flex-col gap-1 text-left"
      >
      ...
      <motion.div 
        ...
        className="absolute -right-2 sm:-right-4 top-[40px] bg-[#1E293B]/95 backdrop-blur-xs text-emerald-400 p-3 rounded-2xl border border-slate-700/50 shadow-xl z-30 w-38 font-mono text-[8px] leading-normal text-left"
      >
